...
;
if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("mermaid/mermaid");
;
if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("mermaid");
;
if (typeof(OpalLoaded) === 'undefined') OpalLoaded = []; OpalLoaded.push("lib/mermaid");
